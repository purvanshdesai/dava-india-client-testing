  ...
  return (
    <div className='relative'>
      ...
      >
        ...
        <CarouselPrevious
          className='absolute left-[1rem] top-1/2 z-10 -translate-y-1/2 transform'
          variant={'outline2'}
        />
        <CarouselNext
          className='absolute right-[1rem] top-1/2 z-10 -translate-y-1/2 transform'
          variant={'outline2'}
        />
